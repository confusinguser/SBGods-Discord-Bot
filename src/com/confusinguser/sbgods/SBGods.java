...
public class SBGods {
    public static final String VERSION = "0.9.1.4";
    ...
    public static final String VERSION_DESCRIPTION_PATCH = "Added -tax paidlist"; // Change this every patch: 0.8.11.4 -> 0.8.11.5
