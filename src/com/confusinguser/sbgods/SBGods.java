...
public class SBGods {
    public static final String VERSION = "0.9.1.6";
    ...
    public static final String VERSION_DESCRIPTION_PATCH = "Made bot significantly faster"; // Change this every patch: 0.8.11.4 -> 0.8.11.5
