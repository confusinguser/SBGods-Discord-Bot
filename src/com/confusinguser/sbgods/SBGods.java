...
public class SBGods {
    public static final String VERSION = "0.8.11.4";
    ...
    public static final String VERSION_DESCRIPTION_MINOR = "Fixed issues with bot"; // Change this every minor release: 0.8.11.5 -> 0.8.12 // Also, don't make bug fix minor releases, make them patches
    public static final String VERSION_DESCRIPTION_PATCH = "Fixed bugs with -verifyall"; // Change this every patch: 0.8.11.4 -> 0.8.11.5
